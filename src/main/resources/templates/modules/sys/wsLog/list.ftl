...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5><i class="fa fa-list"></i> 服务-日志列表</h5>
        </div>
...
<script type="text/javascript" src="/static/modules/sys/wslog/list.js"></script>
<script type="text/javascript">
    ...
    function exportLog() {
        var keyword=$('input[name="keyword"]').val();
        var logDate=$('#logDate').val();
        window.location.href="/wssys/log/export?keyword="+keyword+"&logDate="+logDate;
        /*$.ajax({
            type: "post",
            url: "/wssys/log/export",
