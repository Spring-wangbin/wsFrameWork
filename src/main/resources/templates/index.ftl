...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/indexserver" frameborder="0" data-id="/main" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 北大医信-交付一部 <a href="" target="_blank">@杨学锋</a>
            </div>
        </div>
    </div>
</div>
