...
function actionFormatter(value, row, index) {
    ...
    var result = "";
    result += "<a style='margin: 3px;' href='javascript:;' class='btn btn-white btn-sm' onclick=\"toLogin('" + url + "')\" title='查看'><span class='glyphicon glyphicon-circle-arrow-right'></span> 查看</a>";
