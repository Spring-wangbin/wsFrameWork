...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
   ...
   /* @ManyToMany(cascade = { CascadeType.REFRESH }, fetch = FetchType.LAZY)
    @JoinTable(name = "f_sys_menu_role", joinColumns = { @JoinColumn(name = "role_id") }, inverseJoinColumns = { @JoinColumn(name = "menu_id") })*/
    private java.util.Set<SysMenu> resources;
